...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_GEN_13 //hcl
#endif
...
#define CUSTOM_MACHINE_NAME "Xanet Pro"
 ...
 */
#define X_DRIVER_TYPE  TMC2130 //hcl
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  90.93
    #define DEFAULT_Ki   11.94
    #define DEFAULT_Kd 173.19
  #endif
#else
...
//
#define REPRAP_DISCOUNT_SMART_CONTROLLER //hcl
